            ...
            @foreach ($data as $employee)
                <tr class="hover:bg-gray-50 transition duration-200">
                    ...
                    <td class="py-3 px-5 text-center">
                        <button command="show-modal" commandfor="dialog({{ $employee->id }})" class="bg-blue-500 hover:bg-blue-600 flex justify-center text-white text-sm font-semibold py-2 px-4 rounded-full">
                            Edit
                        </button>
                    </td>
                </tr>
                            ...
                            <el-dialog-panel
                                ...
                                <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div
                                        ...
                                        <h2 id="dialog-title" class="text-xl font-semibold text-white">Edit Employee
                                        </h2>
                                    ...
                                    <form action="{{ route('employees.update', $employee->id) }}" method="post"
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <input type="text" name="email" id="employee_name"
                                                class="bg-gray-700 text-white rounded-lg w-full p-2 border border-gray-600 
                                            focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                                placeholder="Enter employee name" value="{{ $employee->email }}">
                                        </div>
