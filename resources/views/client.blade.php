                    ...
                    @foreach ($data as $client)
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="py-3 px-5 text-center">
                                <button command="show-modal" commandfor="dialog({{ $client->id }})"
                            ...
                            <td class="py-3 px-5 text-center">
                                ...
                                <button command="show-modal" commandfor="deleteDialog({{ $client->id }})"
                                        ...
                                        <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                            ...
                                            <form action="{{ route('clients.update', $client->id) }}" method="post"
                                                ...
                                                <div class="flex flex-col">
                                                    <label for="client_name" class="text-white text-lg mb-2">Client Name
                                                        :</label>
                                            ...
                                            focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                                ...
                                                <!-- client Description -->
                                                <div class="flex flex-col">
                                                    <label for="client_name" class="text-white text-lg mb-2">Client
                                                        Email
                                                        :</label>
                                                    <input type="text" name="email" id="client_name"
                                                        class="bg-gray-700 text-white rounded-lg w-full p-2 border border-gray-600 
                                            focus:ring-2 focus:ring-blue-500 focus:outline-none"
                        ...
                        <el-dialog>
                            <dialog id="deleteDialog({{ $client->id }})" aria-labelledby="dialog-title"
                                ...
                                <div class="flex items-center justify-center min-h-full p-6">
                                    <el-dialog-panel
                                        ...
                                        <div
                                            ...
                                            <h2 class="text-xl font-bold text-gray-800">Delete Client</h2>
                                            <button type="button" command="close"
                                                commandfor="deleteDialog({{ $client->id }})"
                                        ...
                                        <div class="p-8">
                                            ...
                                            <p class="pb-5">Are you sure you want to delete {{ $client->name }}?
                                            </p>
                                        </div>
                                        <div class="flex justify-end mt-5 p-5 border-t border-gray-600">
                                            <button command="close" commandfor="deleteDialog({{ $client->id }})"
                        ...
                        <el-dialog-panel
                            ...
                            <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                    ...
                                    <!-- client Description -->
                                    <div class="flex flex-col">
                                        <label for="client_name" class="text-white text-lg mb-2">Client Email
                                            :</label>
                                        <input type="text" name="email" id="client_name"
                                            class="bg-gray-700 text-white rounded-lg w-full p-2 border border-gray-600 
                                focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                    ...
                                    <div class="flex flex-col">
                                        <label for="password" class="text-white text-lg mb-2">Password
                                            :</label>
                                        <input type="password" name="password" id="client_name"
                                            class="bg-gray-700 text-white rounded-lg w-full p-2 border border-gray-600 
                                    focus:ring-2 focus:ring-blue-500 focus:outline-none"
